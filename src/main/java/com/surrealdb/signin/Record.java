 ...
 * (or the values returned by {@link com.surrealdb.Surreal#useNs(String)} etc.). Call those first when omitting ns/db.
 * <p>
...
public class Record implements Credential {
     ...
     *
     * @param namespace namespace name (may be null to use session default)
     * @param database  database name (may be null to use session default)
     ...
     * Requires {@link com.surrealdb.Surreal#useNs(String)} and {@link com.surrealdb.Surreal#useDb(String)}
     * (or {@link com.surrealdb.Surreal#useDefaults()}) to have been called first.
     *
     * @param access access method name (as defined in DEFINE ACCESS)
     * @param params signup/signin variables (e.g. map with "email", "password"); will be serialized
     */
