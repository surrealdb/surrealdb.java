...
public class Token {
	 ...
	 *
	 * @param access
	 *            the access token (JWT), must not be null
	 * @param refresh
	 *            the refresh token, or null if not provided by the server
	 */
	...
	/**
	 * Returns the access token. Kept for backward compatibility; prefer
	 * {@link #getAccess()}.
	 *
	 * @return the access token
	 */
