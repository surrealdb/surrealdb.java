...
public class Helpers {
    ...
    public static final Person emmanuel = new Person("Emmanuel", Collections.emptyList(), 3, true, Collections.singletonList(new Email("emmanuel@example.com", new Name("Jamie", "Baz"))));
